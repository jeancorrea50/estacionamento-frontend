...
export class AndamentosPageComponent {
  ...
  readonly menuSidebar: MenuLink[] = [
    ...
    { label: 'Faturamento', route: '/app/faturamento' },
  ...
  readonly telas: TelaItem[] = [
    ...
    { rota: '/app/faturamento', tela: 'Faturamento', descricao: 'Página de faturamento.' },
  ...
  readonly arquivosRotas: { arquivo: string; responsabilidade: string }[] = [
    ...
    { arquivo: 'src/app/features/financeiro/financeiro.routes.ts', responsabilidade: '/app/faturamento.' },
