...
export class AndamentosPageComponent {
  ...
  readonly menuSidebar: MenuLink[] = [
    ...
    { label: 'Cadastro > Transportadoras', route: '/app/cadastro/transportadoras' },
    { label: 'Cadastro > Veículos', route: '/app/cadastro/veiculos' },
    { label: 'Cadastro > Motoristas', route: '/app/cadastro/motoristas' },
  ...
  readonly telas: TelaItem[] = [
    ...
    { rota: '/app/cadastro/transportadoras', tela: 'Transportadoras', descricao: 'Cadastro de transportadoras.' },
    { rota: '/app/cadastro/veiculos', tela: 'Veículos', descricao: 'Cadastro de veículos (frota).' },
    { rota: '/app/cadastro/motoristas', tela: 'Motoristas', descricao: 'Cadastro de motoristas.' },
    { rota: '/app/cadastro/estacionamento', tela: 'Estacionamento', descricao: 'Listagem e formulário de estacionamentos.' },
